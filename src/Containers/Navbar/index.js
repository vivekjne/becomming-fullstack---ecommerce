      ...
      <React.Fragment>
        ...
        <div className={`${styles.bottomHeader} container`}>
          <div className={styles.linkContainer}>
            <a className={styles.bottomLink}>Home</a>
          </div>
          <div className={styles.linkContainer}>
            <a className={styles.bottomLink}>categories</a>
            <i className={`fas fa-chevron-down ${styles.bottomLink}`} />
          </div>

          <div className={styles.linkContainer}>
            <a className={styles.bottomLink}>products</a>
            <i className={`fas fa-chevron-down ${styles.bottomLink}`} />
          </div>

          <div className={styles.linkContainer}>
            <a className={styles.bottomLink}>pages</a>
            <i className={`fas fa-chevron-down ${styles.bottomLink}`} />
          </div>

          <div className={styles.linkContainer}>
            <a className={styles.bottomLink}>features</a>
            <i className={`fas fa-chevron-down ${styles.bottomLink}`} />
          </div>
        </div>
      </React.Fragment>
